...
//                .transitionWithPointerState( () -> (pid_driving && drivepid.atTarget()), States.RESTING)
                ...
                .transition( () -> (robot.getDistance() <= 4.0)) //distance sensor says we are close enough
                .transition( () -> (pid_driving && drivepid.atTarget()) )
                ...
                .transition( () -> (robot.getDistance() <= 3.0)) //distance sensor says we are close enough
                .transition( () -> (pid_driving && drivepid.atTarget()) )
